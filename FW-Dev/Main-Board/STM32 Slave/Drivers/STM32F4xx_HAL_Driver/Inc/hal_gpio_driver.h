...
#define  _HAL_RCC_TIM8_CLK_ENABLE()       (RCC->APB2ENR |=  (1 << 1) )
...
#define  _HAL_RCC_ADC3_CLK_ENABLE()        (RCC->APB2ENR |=  (1 << 10) )
#define _HAL_RCC_DMA1_CLK_ENABLE()        (RCC->AHB1ENR |=  (1 << 21) )
#define _HAL_RCC_DMA2_CLK_ENABLE()        (RCC->AHB1ENR |=  (1 << 22) )
#define  _HAL_RCC_TIM11_CLK_ENABLE()       (RCC->APB2ENR |=  (1 << 18) )
